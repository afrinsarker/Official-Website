<template>
    <div class="section-padding contact-section fix bg-cover" data-overlay="0.7" :style="{backgroundImage: `url('/images/bg/contact-bg.jpg')`}">
        <div class="container">
                    ...
                    <div class="contact-Information mr-xl-7">
                        ...
                        <div class="contact-info info-light" data-vivus-hover>
                            ...
                            <div class="info">
                                ...
                                <span class="info-text"> uttara Dhaka-1230, Bangladesh.</span>
                            </div>
                        </div>
                        ...
                        <div class="contact-info info-light" data-vivus-hover>
                            ...
                            <div class="info">
                                ...
                                <span class="info-text"> (+88) 0168-080-0810 </span>
                            </div>
                        </div>
                        <!-- Contact Info Item End -->
